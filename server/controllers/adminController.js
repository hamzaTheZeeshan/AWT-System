...
// @access  Private/Admin
// NOTE: Orphanage and receiver are now separate independent tables.
//       This endpoint returns only general (non-orphanage) receivers.
...
export const deleteReceiver = async (req, res) => {
  try {
    ...
    // Check if receiver has distributions before deleting
